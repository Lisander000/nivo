...
const orders = [
  { id: "KA-20412", date: "Apr 09, 2026", total: 128.90, status: "Delivered", items: [{ emoji: "📱", name: "Samsung Galaxy A55", qty: 1 }, { emoji: "🎧", name: "JBL Tune 510BT", qty: 1 }, { emoji: "🔌", name: "Anker 20W charger", qty: 2 }], seller: "ElectroKS", tracking: "KS-LKX-4418201" },
  { id: "KA-20358", date: "Apr 04, 2026", total: 42.50, status: "In transit", items: [{ emoji: "👟", name: "Nike Air Max 90", qty: 1 }, { emoji: "🧦", name: "Cotton socks 5-pack", qty: 1 }], seller: "SportHouse", tracking: "KS-LKX-4418188" },
  { id: "KA-20301", date: "Mar 28, 2026", total: 89.00, status: "Delivered", items: [{ emoji: "🛏️", name: "IKEA Hemnes 3-drawer", qty: 1 }], seller: "HomeCo", tracking: "KS-LKX-4418144" },
  { id: "KA-20255", date: "Mar 21, 2026", total: 215.00, status: "Delivered", items: [{ emoji: "💻", name: "Logitech MX Master 3S", qty: 1 }, { emoji: "⌨️", name: "Keychron K2 Pro", qty: 1 }], seller: "TechZone", tracking: "KS-LKX-4417990" },
  { id: "KA-20198", date: "Mar 15, 2026", total: 34.00, status: "Returned", items: [{ emoji: "👕", name: "Zara linen shirt L", qty: 1 }], seller: "Zara Kosovo", tracking: "KS-LKX-4417822" },
  { id: "KA-20144", date: "Mar 08, 2026", total: 76.80, status: "Processing", items: [{ emoji: "🌿", name: "Diffuser + oils bundle", qty: 1 }, { emoji: "🕯️", name: "Soy candle trio", qty: 1 }], seller: "AromaKS", tracking: "Pending" },
];
