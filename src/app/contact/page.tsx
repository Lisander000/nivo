    ...
    <div className="max-w-[1280px] mx-auto px-4 lg:px-6 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {[
          ...
          { title: "Email us", desc: "info@nivo.ks", color: "bg-primary", action: "Send email", icon: "M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" },
        ...
        <div className="space-y-4">
          ...
          <div className="relative bg-gradient-to-br from-primary to-primary-dark rounded-2xl shadow-card p-7 text-white overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-[18px] font-black leading-tight mb-1">Nivo sh.p.k.</p>
          ...
          <div className="bg-accent-light rounded-2xl p-6 border border-accent/10">
            ...
            <p className="text-[13px] text-ink-secondary leading-relaxed mb-3">
              Looking to sell on Nivo or open a business account?
            </p>
            <div className="flex gap-2">
              <Link href="/sell" className="text-[12px] font-extrabold text-accent-dark hover:underline">Sell on Nivo →</Link>
              <span className="text-ink-faint">·</span>
              <Link href="/business" className="text-[12px] font-extrabold text-accent-dark hover:underline">Nivo Business →</Link>
            </div>
          </div>
        </div>
      </div>
