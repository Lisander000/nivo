...
export default function SellerSidebar() {
  ...
  return (
    <aside className="w-[240px] flex-shrink-0 border-r border-white/5 bg-[#08080F] min-h-[calc(100vh-64px)] sticky top-[64px]">
      <div className="p-4">
        {/* Store card */}
        ...
        <div className="mt-6 pt-5 border-t border-white/5">
          <Link href="/seller/login" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[12px] font-bold text-white/40 hover:text-white hover:bg-white/5 transition-colors">
          ...
          <Link href="/" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[12px] font-bold text-white/40 hover:text-white hover:bg-white/5 transition-colors">
            <svg className="w-[16px] h-[16px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
